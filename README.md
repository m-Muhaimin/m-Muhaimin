...
I'm a software engineer who builds complete products — React/Next.js on the front, Node.js/FastAPI on the back, and increasingly an AI layer (LLM APIs, RAG, agentic workflows) woven through the stack. My background in PyTorch/TensorFlow means I'm just as comfortable training a model as I am shipping the API around it.
...
**Frontend**
<br/>
<img src="https://skillicons.dev/icons?i=react,nextjs,ts,js,html,css,bootstrap&theme=dark" />

<br/><br/>

**Backend & Data**
<br/>
<img src="https://skillicons.dev/icons?i=nodejs,express,fastapi,sqlite,mysql,py&theme=dark" />
...
**Tools**
<br/>
<img src="https://skillicons.dev/icons?i=git,github,linux,wordpress,vscode&theme=dark" />
...
### 🕸️ [SuprBuild Mesh](https://github.com/m-Muhaimin/suprbuild-mesh)
Agent-oriented task mesh — authentication, persistence, task execution and reputation, built as a structured Node.js/Express/SQLite backend.
...
### 💸 Krostio / KrostioChat
Income-tracking product for gig workers — exploring AI-powered, conversational product experiences on top of application logic.
...
### 🧬 PhyloVAE
Variational-autoencoder approaches for phylogenetic, tree-structured data — applied deep-learning research work in PyTorch.
...
- 🔭 Building out **SuprBuild Mesh** and **Krostio**
- 🧠 Deepening AI/LLM engineering — RAG pipelines, agentic workflows, semantic search
- 🇧🇩 Focused on products for Bangladeshi and South/Southeast Asian users
- 📫 Reach me at **mahmudalmuhaimin055@gmail.com**
